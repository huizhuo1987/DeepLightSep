...
class Pix2PixModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['joint', 'color']#['G_GAN', 'G_L1', 'D_real', 'D_fake']
        # specify the images you want to save/display. The program will call base_model.get_current_visuals
        self.visual_names = ['rgb_img', 'chrom', 'predication']
    ...
    def set_input(self, input):
        ...
        self.lightColors = input['lightColor'].to(self.device)
    def forward(self):
        self.predication = self.netG(self.rgb_img)
    ...
    def backward_D(self):
        ...
        fake_AB = self.fake_AB_pool.query(torch.cat((self.real_A, self.fake_B*self.mask), 1))
    ...
    def backward_G(self):
        ...
        """
        self.loss_joint = self.loss(self.chrom, self.predication, self.mask, self.rgb_img,
                                    self.lightColors)

        self.loss_joint.backward()
